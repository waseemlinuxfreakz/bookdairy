            ...
            <div className="container">
                ...
                <div className="accountDetailsBox">
                    <a href='#' className="account_detailbox">
                        <div className="account_left_icon"><i class="fas fa-user-cog"></i></div>
                        <div className="account_content">
                            <h2>Account details</h2>
                            <p>Manage your name and email address</p>
                        </div>
                        <div className="account_froword"><i class="fas fa-chevron-right"></i></div>
                    </a>
                    <br />
                    <a href='#' className="account_detailbox">
                        <div className="account_left_icon"><i class="far fa-address-card"></i></div>
                        <div className="account_content">
                    ...
                    <br />
                    <a href='#' className="account_detailbox">
                        <div className="account_left_icon"><i class="fas fa-envelope"></i></div>
                        <div className="account_content">
                    ...
                    <br />
                    <a href='#' className="account_detailbox">
                        <div className="account_left_icon"><i class="fas fa-file-alt"></i></div>
                        <div className="account_content">
                            <h2>Terms of use</h2>
                            <p>Manage the emails you receive from us</p>
                        </div>
